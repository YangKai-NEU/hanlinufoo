...
$("#delete_section_1").click(function () {
    var sid = $("#subject").val();
    var secid = $("#section1").val();
    $div1.show();
    $.ajax({
        type: "POST",
        url: "../action/section_delete.class.php",
...
$("#delete_section_2").click(function () {
    var sid = $("#subject").val();
    var secid = $("#section2").val();
    $div1.show();
    $.ajax({
        type: "POST",
        url: "../action/section_delete.class.php",
...
$("#delete_section_3").click(function () {
    var sid = $("#subject").val();
    var secid = $("#section3").val();
    $div1.show();
    $.ajax({
        type: "POST",
        url: "../action/section_delete.class.php",
...
$("#delete_section_4").click(function () {
    var sid = $("#subject").val();
    var secid = $("#section4").val();
    $div1.show();
    $.ajax({
        type: "POST",
        url: "../action/section_delete.class.php",
