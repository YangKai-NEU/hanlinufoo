...
class ChoiceClass
{
     ...
     * @param string $m_select_a
     * @param string $m_select_b
     * @param string $m_select_c
     * @param string $m_select_d
     ...
     */
    public function __construct($m_id, $m_question, $m_select_a, $m_select_b, $m_select_c, $m_select_d, $m_answer, $m_analyse, $m_exam, $m_solution, $m_imgurl, $m_videourl)
    {
        $this->m_id = $m_id;
        $this->m_question = $m_question;
        $this->m_select_a = $m_select_a;
        $this->m_select_b = $m_select_b;
        $this->m_select_c = $m_select_c;
        $this->m_select_d = $m_select_d;
     ...
     * @return string
     */
    public function getMSelectA()
    {
        return $this->m_select_a;
    }

    /**
     * @param string $m_select_a
     */
    public function setMSelectA($m_select_a)
    {
        $this->m_select_a = $m_select_a;
    }
     ...
     * @return string
     */
    public function getMSelectB()
    {
        return $this->m_select_b;
    }

    /**
     * @param string $m_select_b
     */
    public function setMSelectB($m_select_b)
    {
        $this->m_select_b = $m_select_b;
    }
     ...
     * @return string
     */
    public function getMSelectC()
    {
        return $this->m_select_c;
    }

    /**
     * @param string $m_select_c
     */
    public function setMSelectC($m_select_c)
    {
        $this->m_select_c = $m_select_c;
    }
     ...
     * @return string
     */
    public function getMSelectD()
    {
        return $this->m_select_d;
    }

    /**
     * @param string $m_select_d
     */
    public function setMSelectD($m_select_d)
    {
        $this->m_select_d = $m_select_d;
    }
