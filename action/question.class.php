...
session_start();
if (isset($_SESSION[SUBJECT]) && $_SESSION[SUBJECT] != null && $_SESSION[SUBJECT] != "" && isset($_POST["type"]) && $_POST["type"] != null && isset($_POST["id"]) && $_POST["id"] != null) {
...
if (CACHEENABLE) {
    ...
    $sql = "SELECT * FROM " . $tablename . " WHERE " . $first_charactor . "_id='" . $id . "'";
